...
/**
 * Iterates over an error and all of its causes, returning the first cause for
 ...
 * causes, instead of just the first.
 * @param {Error} err - Error instance to search.
 * @param {Function} predicate - Predicate function or Error constructor.
 * @returns {Array<Error>} - Array of found error causes.
 */
